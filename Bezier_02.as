package 
{
	 ...
	 */
	public class Bezier_02 extends MovieClip 
	{
		...
		public var texto:String = "Lorem ipsum dolor sit posuere.";
		...
		function Bezier_02()
		{
			...
			tl = new TweenLite(p1, 0.8, {y:380, yoyo:true, ease:Linear.easeNone, onUpdate:refreshAll, onComplete:completeALL, onReverseComplete:completeReverseAll } );
			t2 = new TweenLite(p2, 0.8 , { y:140, ease:Linear.easeNone, yoyo:true, onUpdate:refreshAll, onComplete:complete2, onReverseComplete:completeReverse2 } );
		}
		...
		private function completeReverse2():void 
		{
			t2.play();
		}
		...
		var tl:TweenLite;
		var t2:TweenLite;
		private function completeReverseAll():void 
		{
			tl.play();
		}
